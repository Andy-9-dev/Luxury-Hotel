    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className={`relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center transition-all duration-1000 ${
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full mb-6 border border-white/20 transition-all duration-1000 delay-300 ${
          ...
          <h1 className={`text-5xl sm:text-6xl lg:text-7xl font-display font-bold text-white mb-6 leading-tight transition-all duration-1000 delay-500 ${
            isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            Welcome to
            <span className={`block text-primary mt-2 transition-all duration-1000 delay-700 ${
              isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
            }`}>Royal Kiana Suites</span>
          </h1>

          {/* Subheading */}
          <p className={`text-xl sm:text-2xl text-gray-200 mb-10 max-w-2xl mx-auto transition-all duration-1000 delay-900 ${
            isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
          }`}>
          ...
          <div className={`flex flex-col sm:flex-row items-center justify-center gap-4 transition-all duration-1000 delay-1100 ${
            isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            <Link
              to="/offers"
              className="w-full sm:w-auto px-8 py-4 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all duration-300 font-semibold text-lg shadow-2xl hover:shadow-primary/50 hover:scale-105 transform"
            >
              Explore Our Suites
            </Link>
            <Link
          ...
          <div className={`grid grid-cols-1 sm:grid-cols-3 gap-6 mt-16 max-w-3xl mx-auto transition-all duration-1000 delay-1300 ${
            isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
      ...
      <div className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10 animate-bounce transition-all duration-1000 delay-1500 ${
        isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
      }`}>
