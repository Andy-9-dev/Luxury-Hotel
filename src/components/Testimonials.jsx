        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative bg-white dark:bg-surface-dark rounded-2xl shadow-2xl p-8 sm:p-12">
            ...
            <button
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white dark:bg-surface-dark rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center hover:scale-110 border border-gray-200 dark:border-gray-700"
            ...
            <button
              ...
              className="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white dark:bg-surface-dark rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center hover:scale-110 border border-gray-200 dark:border-gray-700"
